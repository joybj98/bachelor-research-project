...
grid_dir = '../downloads/JRA/rawdownloads/uas/1anl_mdl.033_ugrd.reg_tl319.196001_196012.wang528814.nc'
...
def main(args):
    ...
    out.to_netcdf(
        write_dir + f"/{modelType}_{startdate.year}-{startdate.month:0=2}_{variableType}.nc", engine="h5netcdf")
    # return 0
...
if __name__ == '__main__':
    ...
    grid_ds = xr.open_dataset(
        '/home/waterlab/Wang/bachelor_thesis/downloads/JRA/rawdownloads/vas/anl_mdl.034_vgrd.reg_tl319.196101_196112.wang528867', engine='cfgrib')
    ...
    #     startdate_list = pd.date_range(tnt(
    #     TimeIdx[0], timeIdx[-1], freq="MS")
